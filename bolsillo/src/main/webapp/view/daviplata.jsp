    ...
    <article>
        <div class="caja1">
            <div class="caja_1">
                ...
                <button><a href="bolsillo?accionesB=retiroD">Retirar</a></button>
            </div>
            <div class="caja_2">
                <div class="caja_2_1">
                    <h1>Recarga ahora</h1>
                    <button><a href="bolsillo?accionesB=recargaD">Recarga</a></button>
                </div>
                <div class="caja_2_2">
                    <h1>Consultar mi saldo</h1>
                    <button><a href="bolsillo?accionesB=consultaD">Ahorros</a></button></div>
            </div>
        </div>
        <div class="caja2">
